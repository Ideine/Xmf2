...
namespace Xmf2.Components.Navigations
{
	...
	public class NavigationService : INavigationService
	{
		...
		private async Task UpdateNavigationStack(List<ScreenInstance> newNavigationStack)
		{
			...
			{
				navigationOperation.Add(new NavigationOperation.Pop(_navigationStack[i]));
			}
			...
			{
				navigationOperation.Add(new NavigationOperation.Push(newNavigationStack[i]));
		...
		private class NavigationInProgress : INavigationInProgress
		{
