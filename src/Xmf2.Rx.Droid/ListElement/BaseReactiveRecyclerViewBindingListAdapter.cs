...
{
	public class BaseReactiveRecyclerViewBindingListAdapter<TItemData, TViewHolder> : RecyclerView.Adapter where TViewHolder : RecyclerView.ViewHolder, IRecyclerViewViewHolder
    {
        ...
        public BaseReactiveRecyclerViewBindingListAdapter(Context context)
        {
            Context = context;
        }

        protected BaseReactiveRecyclerViewBindingListAdapter(IntPtr javaRef, Android.Runtime.JniHandleOwnership transfer) : base(javaRef, transfer) { }
