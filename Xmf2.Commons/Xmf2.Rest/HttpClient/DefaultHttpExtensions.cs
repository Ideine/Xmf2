...
namespace Xmf2.Rest.HttpClient
{
	...
	internal static class DefaultHttpExtensions
	{
		...
		/// <summary>
		/// Converts the <see cref="System.Net.Http.HttpContent"/> to a <see cref="IHttpContent"/>
		/// </summary>
		/// <param name="content">The <see cref="System.Net.Http.HttpContent"/> to convert</param>
		/// <returns>The converted <see cref="System.Net.Http.HttpContent"/></returns>
		...
		/// <summary>
		/// Creates a <see cref="System.Net.Http.HttpRequestMessage"/> from a <see cref="IHttpRequestMessage"/>
		/// </summary>
		/// <param name="message">The <see cref="IHttpRequestMessage"/> used to create the <see cref="System.Net.Http.HttpRequestMessage"/> from</param>
		/// <returns>The <see cref="System.Net.Http.HttpRequestMessage"/> created from <paramref name="message"/></returns>
